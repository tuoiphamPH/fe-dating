...
export default function ReportFake(){
    ...
    const [reportType, setReportType] = useState("giả mạo");
        ...
        <div>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Báo cáo giả mạo</h2>
                    <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Chào bạn , ai đó đang giả mạo bạn , hãy cho chúng tôi biết , chúng tôi sẽ giúp bạn bằng cách xác minh và khoá tài khoản người dùng nếu điều đó là sự thật</p>
                    <form action="#" className="space-y-8">
                        <div>
                            <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Chủ đề</label>
                            <input type="text" id="subject"  defaultValue={reportType}
                        ...
                        {/*<div>*/}
                        {/*    <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Liên kết tài khoản mạo danh </label>*/}
                        {/*    <input placeholder="Url profile..." type="text" id="subject"*/}
                        {/*           value = {reportLink} onChange={(event) => {*/}
                        {/*        setReportLink(event.target.value);*/}
                        {/*    }}*/}
                        {/*           className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" />*/}
                        {/*</div>*/}
                        <div className="sm:col-span-2">
                            <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Nội dung & tệp đính kèm giấy tờ tuỳ thân </label>
