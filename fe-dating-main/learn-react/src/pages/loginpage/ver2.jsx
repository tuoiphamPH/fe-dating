 ...
 import videoBg2 from "../../assets/videos/videoBg2.mp4"
 import videoBg3 from "../../assets/videos/videoBg3.mp4"
import videoBg4 from "../../assets/videos/videoBg4.mp4"
...
import showLoginForm from "../SwalAlert/showLoginForm.jsx";
            ...
            <div className={"content"}>
                ...
                <div className={"cus-button"}>
                    <button onClick={()=>{
                        ...
                        <p>Introducing the application</p>
                    </button>
                </div>
